const services = [
  ...
  },
  {
    ...
    title: 'Windows',
    description1:
      "Windows play a vital role in the overall comfort, energy efficiency, and aesthetic appeal of a property. At BJB Renos Plus Inc., we understand the importance of properly installed and visually appealing windows, which is why we offer first-rate window installation services that cater to the unique needs of our clients. Our primary objective is to provide window solutions that not only enhance your property's appearance but also improve its insulation, ventilation, and energy efficiency.",
    description2:
      "Our team of experienced professionals at BJB Renos Plus Inc. is proficient in working with a wide array of window styles, materials, and brands, ensuring that we can tailor our window installation services to suit your specific requirements and preferences. Whether you're looking for energy-efficient double-glazed windows, elegant casement windows, or versatile sliding windows, our experts are equipped to deliver impeccable results that meet and exceed your expectations. By partnering with us, you can trust that your windows will be expertly installed to provide optimal performance, durability, and beauty for your property.",
    description3:
